...
public class Page_AdjustBalance {	
	...
	public static void adjustBalance(DesiredCapabilities dc, AndroidDriver<MobileElement> driverApp, String newValue) throws MalformedURLException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException, ClassNotFoundException, InterruptedException {
